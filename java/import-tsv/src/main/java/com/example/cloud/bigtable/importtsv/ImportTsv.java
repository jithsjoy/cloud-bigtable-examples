...
package com.example.cloud.bigtable.importsv;
...
public class ImportTsv {
  ...
  public static void main(String[] args) {
    ...
    p.apply(TextIO.Read.from("gs://books/syntactic-ngrams/eng/biarcs.24-of-99.gz"))
        ...
        .apply(MapElements.via((String line) -> {
                          ...
                          // TODO: report errors for rows that are out of spec
                          String key = elements[1] + "\t" + elements[2] + "\t" + elements[3];
		                      int count = Integer.parseInt(elements[4]);
                          // They byte order of a newly-created byte buffer is
                          ...
                          return (Mutation) new Put(key.getBytes()).addColumn(FAMILY, COUNT_QUALIFIER, countBytes);
        })
